    ...
    <main>
        ...
        <div class="container">
            <div class="row justify-content-center gap-4">
                <form id="inscriptionForm" class = "formuperso col-md-5 col-sm-12 " method="POST" action="php/inscriptionPro.php">
                    <div class = "info form" >
                ...
                <form id="salleForm" class = "formusalle col-md-5 col-sm-12 " method="POST" action="php/inscriptionSalle.php">
                    ...
                    <div class = "bouttondroite">
                        <button type="button" id="btnValider" onclick="validerInscription()"> Valider</button>
                    </div>
                </form>
            </div>
        </div>
