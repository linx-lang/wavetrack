[
    "Scène", "Backstage", "Régie", "Bar", "Vestiaires",
    "Toilettes", "Entrée / Hall", "Zone VIP", "Zone Technique", "Réserve"
];

const products = [
    { id: 1, name: "Bouton", image : "img/bouton.png", price: 10, desc: "Ce produit est conçu pour détecter l'ouverture d'une porte et envoyer une alerte si une intrusion est détectée." },
    { id: 2, name: "Multisensor", image : "img/multisensor.jpg", price: 15, desc: "Ce produit est conçu pour détecter la température, ---, --- dans votre salle de concert." },
    { id: 3, name: "Détecteur Ouverture Porte", image : "img/porte.png", price: 20, desc: "Ce produit sert à activer votre climatiseur ou bien compter le nombre de fois où vos vestiaires ont servis." },
    { id: 4, name: "Prise Murale Connectée", image : "img/wallplug.jpg", price: 25, desc: "Ce produit est utilisé pour analyser le nombre de watt utilisés par chacune de vos machines." }
];
