const zones = [
    ...
    "Entrée / Hall", "Zone Technique"];

const products = [
    { id: 1, name: "Bouton", image : "img/bouton.webp", price: 10, desc: "Ce produit est conçu pour détecter l'ouverture d'une porte et envoyer une alerte si une intrusion est détectée." },
